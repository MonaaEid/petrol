...
//   console.log(date);
  $.ajax({
                  ...
                  method:'GET' ,
                  url:"{{route ('EgmalyHesabMonth_result')}}" ,
                  data:{date: date} ,
                  // dataType:'json' ,//return data will be json
                  success: function () {
                      $('#monsh').load('/EgmalyHesabMonth_result');
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="contact wow fadeInUp">
                <div class="container">
                    <div class="section-header text-center">
                        <h2>ااختيار يوم لعرض اجمالى المحاسبة للشهر </h2>
                        
                        <div class="col-md-6 container">
                            <div id="success"></div>
                            <form  id="contactForm" method="GET" action="EgmalyHesabMonth_result">
