...
<div class="contact wow fadeInUp">
    <div class="container ">
         <div class="section-header text-center">
                        ...
                        <h2 style="font-family:Monadi">اضافة تسعير للوقود</h2>
    ...
    <div id="success">
        ...
        <form name="sentMessage" action="/store-fuel-pricing" method="POST" id="contactForm" novalidate="novalidate">
            @csrf
            ...
            <div class="control-group mb-2">
                    <select  name="oil_gas_id" class=" form-control" required="required" >
                        <option disabled selected>الوقود</option>
